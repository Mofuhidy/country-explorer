...
function CountryDetails() {
  ...
  const languagesArray = countryData
    ? Object.entries(countryData[0].languages)
    : [];
        ...
        <div className="details  h-auto flex justify-center">
          <ul className=" flex flex-col justify-center overflow-y-auto w-full h-96">
            <li className="flex justify-between px-8 h-16 items-center">
              ...
              <span className=" w-5">
                <img src={countryData[0].coatOfArms} alt="Coat of arms"></img>
              </span>
            </li>
            <li className="flex justify-between px-8 h-16 items-center">
            ...
            <li className="flex justify-between px-8 h-16 items-center">
              ...
              {languagesArray.map(([languageCode, languageName], index) => (
